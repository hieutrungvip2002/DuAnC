...
<head>
    ...
    <link href="{{ asset("public/backend") }}/css/paper-dashboard.css?v=2.0.1" rel="stylesheet" />
...
<script src="{{ asset("public/backend") }}/js/paper-dashboard.min.js?v=2.0.1" type="text/javascript"></script><!-- Paper Dashboard DEMO methods, don't include it in your project! -->
